...
var render = function render() {
  ...
  return _c("div", {
    ...
    return _c("ul", {
      ...
      staticClass: "id"
    }, [_vm._v("#" + _vm._s(post.id))]), _vm._v(" "), _c("li", [_vm._v(_vm._s(post.name))]), _vm._v(" "), _c("li", [_vm._v(_vm._s(post.location))]), _vm._v(" "), _c("li", [_vm._v(_vm._s(post.email))])]);
  }), 0)])]);
};
